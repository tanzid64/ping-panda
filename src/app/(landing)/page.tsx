...
import { VerificationBadgeIcon } from "@/icons/verification-badge";
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            ...
            <Heading>Stay ahed with real-time insights</Heading>
          </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px))] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  {/* max-lg -> means until lg device use text-center means till md device in tailwind css */}
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  {/* cqw -> container query width -> allows to set width based on container that hase [container-type:inline-size] */}
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  <p className="font-semibold flex items-center">
                    Freya Larsson
                    <VerificationBadgeIcon className="size-4 inline-block ml-1.5" />
                  </p>
